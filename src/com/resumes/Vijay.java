...
public class Vijay{
		...
		
		{
			...
			org.apache.poi.ss.usermodel.Cell UsernameCell = wb.getSheet("Sheet1").getRow(1).getCell(0);
			String Username = UsernameCell.toString();
			org.apache.poi.ss.usermodel.Cell PasswordCell = wb.getSheet("Sheet1").getRow(1).getCell(1);
			...
			driver.findElement(By.xpath("//input[@id = 'attachCV']")).sendKeys("D:\\MyWorkspace\\DailyUploadTool\\Data\\VijayVasi_AutomationTestEngineer.docx");
